...
def test_average_two_list_gt(setup):
    ...
    lst1 = [2, 2, 2]
    lst2 = [3, 3, 3]
    assert average_2list.average_two_lst(lst1, lst2) == 'Второй список имеет большее среднее значение', 'test_average_two_list_gt failed'
...
def test_average_two_list_lt(setup):
    ...
    lst2 = [2, 2, 2]
    lst1 = [3, 3, 3]
    assert average_2list.average_two_lst(lst1, lst2) == 'Первый список имеет большее среднее значение', 'test_average_two_list_lt failed'

def test_average_two_list_same(setup):
    _, average_2list = setup
    lst1 = [2, 2, 2]
    lst2 = [2, 2, 2]
    assert average_2list.average_two_lst(lst1, lst2) == 'Средние значения равны', 'test_average_two_list_same failed'
